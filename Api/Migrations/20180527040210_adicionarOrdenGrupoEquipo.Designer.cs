...
namespace Api.Migrations
{
    ...
    [Migration("20180527040210_adicionarOrdenGrupoEquipo")]
    partial class adicionarOrdenGrupoEquipo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.GrupoEquipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Api.Models.ProgramacionJuego", b =>
                {
                    ...
                    b.HasIndex("GrupoEquipoId");

                    b.ToTable("ProgramacionJuego");
                });

            modelBuilder.Entity("Api.Models.ResultadosJuego", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Api.Models.ProgramacionJuego", b =>
                {
                    ...
                    b.HasOne("Api.Models.GrupoEquipo", "GrupoEquipo")
                        .WithMany()
                        .HasForeignKey("GrupoEquipoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
